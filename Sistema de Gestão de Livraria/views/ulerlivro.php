...
<body>
    ...
    <center>
        <div>
            <button id="prev-page" class="btn" style="color:white; broder-color:#ff9300; background-color: #ff9300;"><i
                    class="fa fa-arrow-left" aria-hidden="true"></i></button>
            <button id="next-page" class="btn" style="color:white; broder-color:#ff9300; background-color: #ff9300;"><i
