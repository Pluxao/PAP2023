...
/*$livros = [];
$liv = $pdo->query("SELECT *FROM livros, livros_categorias, usuarios WHERE livros.cod_categoria = livros_categorias.id_categoria AND livros.cadastrador = usuarios.id ORDER BY cod_categoria");
if($liv->rowCount() > 0){
...
<body>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/livraria.jpg">
                        <div class="hero__text">
                            ...
                            <a href="#todoslivros" class="primary-btn">Ver Livros</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="featured spad" id="todoslivros">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
