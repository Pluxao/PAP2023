    ...
    if($id){
        $sql = $pdo->prepare("SELECT *FROM usuarios WHERE id = :id");
            ...
            if($sql->rowCount() > 0){
                ...
                header("location:./umeuperfil.php");
            }
        }else{
            header("location:./umeuperfil.php");
        }
...
<div class="main-header">
        ...
        <div class="cadastrar_form" id="perfil">
			<form action="usenha_action.php" method="post">
            <input type="text" name="id" value="<?=$usuario['id']?>" hidden>
            <input type="password" placeholder="Nova senha" name="senha" minlength="8" maxlength="16" required><br><br>
            <input type="password" placeholder="Confirmar nova senha" name="confsenha" minlength="8" maxlength="16" required><br><br>
            <button class="primary-btn" type="submit">Actualizar senha</button>
        	</form>
        </div>
    </section>
								</div>
