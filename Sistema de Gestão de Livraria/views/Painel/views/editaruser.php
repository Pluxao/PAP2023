...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<h2>Os dados dos usuários são protegidos pela lei da proteção dos dados pessoais(Lei n.º22/11, de 17 de Junho).</h2>
            
        </div>
        <div class="cadastrar_form" id="perfil">
		<form method="post" action="editaruser_action.php" >
                <input type="text" name="id" hidden value="<?php echo $usuario['id']?>">
                <input type="text" name="user" value="<?php echo $usuario['user']?>">
                <input type="text" name="pnome" value="<?php echo $usuario['pnome']?>">
                <input type="text" name="unome" value="<?php echo $usuario['unome']?>">
                <input type="email" name="email" value="<?php echo $usuario['email']?>">
                <input type="text" name="telefone" value="<?php echo $usuario['telefone']?>">
                <input type="text" name="nasc" value="<?php echo $usuario['nasc']?>">
                <select name="genero" value="<?php echo $usuario['telefone']?>" style="margin: 1%;">
