...
if (!empty($_GET['search'])) {
	$comentarios = [];
	$data = $_GET['search'];
	$coment = $pdo->query("SELECT *FROM comentarios, posts, usuarios WHERE comentarios.cod_post = posts.id_post AND comentarios.comentador = usuarios.id AND (id_comentario LIKE '%$data%' or cod_post LIKE '%$data%' or comentador LIKE '%$data%' or comentario LIKE '%$data%'  or titulo_post LIKE '%$data%'  or pnome LIKE '%$data%'  or unome LIKE '%$data%') ORDER BY id_comentario");
...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<a class="btn btn-primary" href="comentariosrl.php">Relatório</a>
								</div>
							</div>
							<div class="card-body">
								<div class="row">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<a
																href="editarcomentario.php?id_comentario=<?= $comit['id_comentario']; ?>"><button
															...
															<a
																href="excluircomentario.php?id_comentario=<?= $comit['id_comentario']; ?>">
	...
	<script>
		...
		function searchData() {
			window.location = "comentarios.php?search=" + search.value;
		}
