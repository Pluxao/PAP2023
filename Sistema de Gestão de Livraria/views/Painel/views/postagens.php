...
if (!empty($_GET['search'])) {
	$listapost = [];
	$data = $_GET['search'];
	$posts = $pdo->query("SELECT *FROM posts, usuarios WHERE posts.postador = usuarios.id AND (id_post LIKE '%$data%' or titulo_post LIKE '%$data%' or post LIKE '%$data%' or postador LIKE '%$data%' or data_post LIKE '%$data%' or pnome LIKE '%$data%' or unome LIKE '%$data%') ORDER BY id_post");
	if ($posts->rowCount() > 0) {
...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<a href="postagensrl.php"><button class="btn btn-primary">Relatório</button> </a>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<p class="small">Fazer nova postagem</p>
												<form method="post" action="postar_action.php" autocomplete="off"
													...
													<div class="row">
														...
														<div class="col-md-12">
															<div class="form-group form-group-default">
																...
																<textarea name="post" id="addOffice"
																	pleaceholder="Escreva Alguma coisa..." cols="30"
																	rows="10"></textarea>
															</div>
														</div>
														<input type="text" hidden name="postador"
															value="<?php echo $consulta['id']; ?>">
													</div>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<a href="editarpost.php?id_post=<?= $postagem['id_post']; ?>"><button
															...
															<a href="excluirpost.php?id_post=<?= $postagem['id_post']; ?>">
	...
	<script>
		...
		function searchData() {
			window.location = "postagens.php?search=" + search.value;
		}
