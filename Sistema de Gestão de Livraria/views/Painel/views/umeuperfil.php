...
<div class="main-header">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<a href="umeuperfil.php" class="btn btn-xs btn-secondary btn-sm">
													Ver Perfil
												</a>
											</div>
										</div>
									...
									<li>
										...
										<a class="dropdown-item" href="umeuperfil.php">Meu Perfil</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="umeuperfil.php">Editar Perfil</a>
										<div class="dropdown-divider"></div>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									<li>
										<a href="umeuperfil.php">
											<span class="sub-item">Meu Perfil</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="../../utodoslivros.php">
											<span class="sub-item">Livros</span>
										</a>
									</li>
									<li>
										<a href="../../uplataforma.php">
								...
								<div class="card-body">
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<form action="uimagem.php" method="post" autocomplete="off" enctype="multipart/form-data">
												<input type="text" name="id" hidden value="<?php echo $consulta['id']?>">
												<label for="imagem_perfil"><img style="width: 200px; height: 200px; border-radius: 100%;" src="img_upload/<?php echo $consulta['imagem_perfil']?>" alt="Foto de perfil"><br><br></label>
										...
										<div class="px-2 pb-2 pb-md-0 text-center">
											...
											<a href="usenha.php?id=<?=$consulta['id'];?>"><button class="btn btn-primary">Mudar senha</button></a>	
										</div>
									</div>
								</div>
							</div>
        ...
        <div class="cadastrar_form" id="perfil">
            <form method="post" action="ueditarperfil_action.php" >
                <input type="text" name="id" hidden value="<?php echo $consulta['id']?>">
                ...
                <input type="text" name="telefone" value="<?php echo $consulta['telefone']?>" minlength="9" maxlength="9" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                <input type="date" name="nasc" value="<?php echo $consulta['nasc']?>" min="<?php echo date('Y-m-d', strtotime('-100 year'));?>" max="<?php echo date('Y-m-d', strtotime('-6 year'));?>">
