...
<body>
	<div class="wrapper">
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
										...
										<img style="width: 200px; height: 200px; border-radius: 100%;" src="img_upload/<?php echo $consulta['imagem_perfil']?>" alt="Foto de perfil">
		...
		<form action="senha_action.php" method="post">
            <input type="text" name="id" value="<?=$usuario['id']?>" hidden>
            <input type="password" placeholder="Nova senha" name="senha" minlength="8" maxlength="16" required>
            <input type="password" placeholder="Confirmar nova senha" name="confsenha" minlength="8" maxlength="16" required>
            <button style="padding: 3px;" class="primary-btn" type="submit">Mudar senha</button>
        </form>
        </div>
    </section>
								</div>
