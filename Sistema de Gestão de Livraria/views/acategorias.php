    ...
    if($id_categoria){
        ...
        if($livro->rowCount() > 0){
            if (!empty($_GET['search'])){
                $livros = [];
                $data = $_GET['search'];
                $liv = $pdo->prepare("SELECT *FROM livros, livros_categorias WHERE id_categoria = :id_categoria AND livros.cod_categoria = livros_categorias.id_categoria AND (titulo LIKE '%$data%' or editora LIKE '%$data%' or classe LIKE '%$data%' or disponibilidade LIKE '%$data%'  or preco LIKE '%$data%') ORDER BY cod DESC");
                ...
                if($liv->rowCount() > 0){
                    ...
                    echo "<script>window.location = 'acategorias.php?id_categoria=$id_categoria'</script>";
                }
            }
            else{
                $livros = [];
...
<head>
    ...
    <title><?php echo$livs['nome_categoria'];?></title>
                ...
                <div class="col-lg-9">
                        ...
                        <div class="hero__search__form">
                            <div>
                                <div style="width: 30%;
                                    ...
                                    <b><?php echo$livs['nome_categoria'];?></b> 
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/livraria.jpg">
                        <div class="hero__text">
                            ...
                            <h2>Categoria<br><?php echo$livs['nome_categoria'];?></h2>
            ...
            <?php foreach($livros as $livraria): ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mix">
                    <div class="featured__item">
                        <div style="border: 1px solid;" class="featured__item__pic set-bg" data-setbg="painel/views/capas_upload/<?php echo $livraria['img_livro']?>">
                        ...
                        <ul class="featured__item__pic__hover">
                                    ...
                                    if ($livraria['disponibilidade'] == 'Grátis') {
                                        ...
                                        echo '<li><a href="adetalhelivro.php?cod='.$livraria['cod'].'&id_categoria='.$livraria["id_categoria"].'"><i class="fa fa-money"></i></a></li>';
                                    }
                                    ?>
                                </ul>
                        </div>
...
function searchLivros() {
    window.location = "acategorias.php?id_categoria=<?=$id_categoria;?>&search="+search.value; 
}
    </script>
</body>
</html>