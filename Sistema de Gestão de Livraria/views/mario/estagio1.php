...
<!-- Header Section End -->
    <div class="game-board">
        <div class="ponto">Pontuação<b>00</b></div>
        <img src="./imagens/arvores.png" class="arvores">
    ...
    <audio controls loop autoplay class="somjogo" hidden>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <a href="../uhome.php"><button type="button" style="width: 40px; height: 40px;" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body text-center">
            ...
            <a class="btn btn-danger" style ="color: white;" href="index.php"><img style="width: 40px;" src="./imagens/arrow-repeat.svg" alt=""></i></a>
        </div>
